			...
			// ╚═╝     ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝
			 		...
			 		if (tool == "pick") {
						if (material == "wood") then
							...
							damage = 8
							wear = 50
						} else if (material == "sapphire") then
							groupcaps2={
