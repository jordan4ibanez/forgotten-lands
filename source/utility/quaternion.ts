namespace utility {
    ...
    export class Quaternion {
        ...
        toVec3(mutation: Vec3): void {
            mutation.x = atan2(this.x * this.w - this.y * this.z, 0.5 - this.x * this.x - this.y * this.y);
            mutation.y = safeAsin(2.0 * (this.x * this.z + this.y * this.w));
            mutation.z = atan2(this.z * this.w - this.x * this.y, 0.5 - this.y * this.y - this.z * this.z);
        }
