...
__TS__SourceMapTraceBack(debug.getinfo(1).short_src, {["79"] = 2,["81"] = 3,["82"] = 5,["83"] = 5,["85"] = 6,["86"] = 7,["87"] = 8,["88"] = 5,["89"] = 16});
...
do
    ...
    function MinecartEntity.prototype.____constructor(self)
        self.name = "minecart"
        self.object = fakeRef()
        self.initial_properties = {visual = EntityVisual.mesh, mesh = "minecart.b3d", textures = {"minecart.png"}}
    end
